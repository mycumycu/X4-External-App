...
# Repository Layout
- mod directory.  This contains the code for the mod that gets added to the game.
- Everything else.  The web server and content that hosts the information sen by the mod.  It is accessed by the user in their browser locally.
